...
email.href="mailto:lakshmipillari@gmail.com";
email.textContent=basic.email;
child1.appendChild(email);

var m=document.createElement("h3");
m.textContent=basic.mobile;
child1.appendChild(m);
...
child1.appendChild(address);
 ...
 function career(obj){
   ...
   co.textContent=obj.info;
   child2.appendChild(co);
   co.textContent="Career Objective";
   var hline=document.createElement("hr");
   child2.appendChild(hline);
   var pa=document.createElement("p");
   pa.textContent=obj.info;
   child2.appendChild(pa);
   }
